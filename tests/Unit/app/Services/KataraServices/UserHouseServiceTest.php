...
class UserHouseServiceTest extends TestCase
{
    ...
    {
        $this->aangUserService->shouldReceive('get')->andReturn(new Response(new Psr7Response(HttpFoundationResponse::HTTP_OK, [], json_encode(['id' => 1, 'person' => ['id' => 1, 'houses' => [['id' => 1, 'pivot' => ['is_default' => 1, 'house_role_id'
            => HouseRole::HOST]]]]]))));
    ...
    {
        $this->aangUserService->shouldReceive('get')->andReturn(new Response(new Psr7Response(HttpFoundationResponse::HTTP_OK, [], json_encode(['id' => 1, 'person' => ['id' => 1, 'houses' => [['id' => 1, 'pivot' => ['is_default' => 1
